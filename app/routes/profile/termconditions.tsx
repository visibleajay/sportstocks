        ...
        <div className="flex flex-row">
          <div className="flex flex-col">
            <ol className="list-decimal [&>*]:p-1">
              ...
              <li className="style_list-item__1OXWl">
                ...
                <ol className="mx-5 my-2 list-decimal [&>*]:p-px" type="a">
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    ability for Users to add their own opinions,
                    data/information related to a particular future event.
                  </li>
                  <li className="paragraph style_list-item__1OXWl">
                    Depending upon the potential outcome for each specified
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    the two users shall be allowed to withdraw their specific
                    bid and the settlement of the bids between the two users
                    shall be determined basis the occurrence and outcome of the
                    specified future event on which the two User’s have placed
                    their bids. If a User makes a bid on a specified future
                    event but no complementary bid is available till the
                    occurrence of the specified future event, the bid amount
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    To place a bid a User must pay a certain amount that is
                    equivalent/commensurate with the likelihood of occurrence of
                    a specified future event. A winning bid is determined basis
                    the occurrence and outcome of a specified future event. A
                    User’s bid on the said event will be deemed to be successful
                    if the parameters which formed the basis for the User making
                    a bid are met and/or have occurred. If the parameters are
                    which formed the basis for the User making a bid are not met
                    and/or have not occurred the bid shall not be successful.
                  </li>
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    after making a thorough and detailed analysis and
                    determination as to the possibility of success of their
                    individual bids.
                  </li>
                  <li className="paragraph style_list-item__1OXWl">
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    <ul className="list-disc [&>*]:ml-5 [&>*]:p-1">
                      ...
                      <li className="paragraph style_list-item__1OXWl">
                        ...
                        via other media, to other Users seeking to download or
              ...
              <li className="style_list-item__1OXWl">
                <div className="style_title__3pKj6">
                ...
                <ol className="mx-5 my-2 list-decimal [&>*]:p-px" type="a">
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    activities with third parties, including payment providers
                    and verification service providers, are solely between the
                    User and that third party. Users' correspondence,
                    transactions and usage of the services/offers of such third
                    party shall be subject to the terms and conditions, policies
                    and other service terms adopted/implemented by such third
              ...
              <li className="style_list-item__1OXWl">
                <div className="style_title__3pKj6">Privacy Policy</div>
                <ol className="mx-5 my-2 list-decimal [&>*]:p-px" type="a">
                  <li className="paragraph style_list-item__1OXWl">
              ...
              <li className="style_list-item__1OXWl">
                <div className="style_title__3pKj6">User Conduct</div>
                <ol className="mx-5 my-2 list-decimal [&>*]:p-px" type="a">
                  <li className="paragraph style_list-item__1OXWl">
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    <ul className="list-disc [&>*]:ml-5 [&>*]:p-1">
                      ...
                      <li className="paragraph style_list-item__1OXWl">
                        ...
                        disseminate (collectively, "<b>Transmit</b>") any
                      ...
                      <li className="paragraph style_list-item__1OXWl">
                        ...
                        labels of the origin or the source of software or other
                        material
                      </li>
                      <li className="paragraph style_list-item__1OXWl">
              ...
              <li className="style_list-item__1OXWl">
                ...
                <ol className="mx-5 my-2 list-decimal [&>*]:p-px" type="a">
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    Persons who wish to participate must have a valid phone
                    number.
                  </li>
                  <li className="paragraph style_list-item__1OXWl">
              ...
              <li className="style_list-item__1OXWl">
                ...
                <ol className="mx-5 my-2 list-decimal [&>*]:p-px" type="a">
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    not resolved within 30 (thirty) days from the date of
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    of the Delhi International Arbitration Centre (“
                    <b>DIAC Rules</b>”), which rules are deemed to be
                    incorporated by reference in this clause. The seat of the
                    arbitration shall be New Delhi. The Tribunal shall consist
                    of one arbitrator. The language of the arbitration shall be
              ...
              <li className="style_list-item__1OXWl">
                ...
                <ol className="mx-5 my-2 list-decimal [&>*]:p-px" type="a">
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    <ul className="list-disc [&>*]:ml-5 [&>*]:p-1">
                      <li className="paragraph style_list-item__1OXWl">
                        Name and contact details: name, address, contact number
                        and email address
                      </li>
                      <li className="paragraph style_list-item__1OXWl">
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    <ul className="list-disc [&>*]:ml-5 [&>*]:p-1">
                      ...
                      <li className="paragraph style_list-item__1OXWl">
                        A statement that the information provided in the notice
                        is accurate and that the signatory is authorized to act
                        on behalf of the owner of an exclusive copyright right
                        that is allegedly infringed;
                      </li>
                      <li className="paragraph style_list-item__1OXWl">
                        User’s signature or a signature of the User’s authorized
                        agent.
                      </li>
                    </ul>
                  ...
                  <li className="paragraph style_list-item__1OXWl">
                    ...
                    acknowledges that timely assistance with the investigation
